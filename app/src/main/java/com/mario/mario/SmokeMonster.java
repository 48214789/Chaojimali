...
public class SmokeMonster extends Enemy
{
	...
	{
		canvas.save();
		canvas.scale(1, this.state.equals("�ƶ�") && !this.hitbullet_or_tortoise ? 1 : -1, this.x+this.image.getWidth()/2, this.y+ this.image.getHeight()/2);
